                            ...
                            <ul class="paging4"> 
                                ...
                                <li>
                                    <div class="partneri">
                                        ...
                                        Provozujeme specializovanı maloobchodní a velkoobchodní e-shop s cyklistickım zboím.
                                        Jsme vıhradní dovozce a distributor øady svìtovıch cyklistickıch znaèek pro Èeskou
                                        republiku a Slovensko. Online prodej cyklistického obleèení NUCKILY a SOOMOM, brašen
                                        ROSWHEEL, svítilen FEREI, øazení microSHIFT, klik DRIVELINE a dalšího zboí.<br />
                                    </div>
                                </li>
                                <li>
                                    <div class="partneri">
                                        ...
                                        a originálních dílù (OE) pro automobilovı a strojní prùmysl. Produkty spoleènosti
                                        MANN+HUMMEL jsou vyrobeny na základì nejvyšší kvality. To platí také pro dodávky
                                        originálních dílù (OE) dodávanıch do automobilek a dílù pro náhradní spotøebu se
                                ...
                                <li>
                                    <div class="partneri">
                                        ...
                                        Catlike je španìlskı vırobce špièkovıch cyklistickıch pøileb a brılí, které pouívají
                                        závodníci i na Tour de France, Giru,Vueltì a MS. Vrcholem v nabídce znaèky je model
                                        Whisper, kterı je v nabídce firmy s kadoroèními inovacemi ji ètyøi roky. Mohli
                                        jste jej spatøit na hlavách dvou olympijskıch vítìzù 2008 (Julien Absalon a Samuel
                                        Sánchez) , Thor Hushovd /mistr svìta 2010 na silnici/ i mistrynì svìta v XC 2008
                                        (Marga Fullana). V Catlike pøilbách letos bude závodit novı silnièní profiteam Movistar,
                                        ale i èeské tımy.
                                        <br />
                                    </div>
                                </li>
                                <li>
                                    <div class="partneri">
                                        ...
                                        Prémiová kvalita pro vaše zdraví a ještì lepší vıkon! Ne vdy je kvalita tam, kde
                                        je to na vırobku napsáno. Podobnì jako skvìlı kuchaø nemùe ze špatnıch surovin
                                        pøipravit dobré jídlo, tak ani špatnı kuchaø z dobrıch surovin nepøichystá lahodnı
                                        pokrm. Pro vırobky prémiové kvality je rozhodující správné sloení, èistota ingrediencí
                                        a pøísnì kontrolované vırobní postupy. A pøesnì to vám nabízí sportovní vıiva INKOSPOR
                                        ve svıch produktovıch øadách ACTIVE a X-TREME. Sportovní vıiva INKOSPOR se vyznaèuje
                                        pøedevším následujícími vlastnostmi: Produkty se vyrábí podle nejnovìjších sportovnì-vìdeckıch
                                        poznatkù z tìch nejlepších surovin a prochází øadou odbornıch testù a analız. Produkty
                                        podléhají pøísné permanentní kontrole jakosti, je zaruèuje jejich nejvyšší kvalitu
                                        a bezpeènost. Nemìcká znaèka INKOSPOR disponuje vlastním vızkumem, vıvojem a produkcí
                                        na nejvyšší evropské úrovni. Všechny produkty se mohou pochlubit mimoøádnì vytøíbenou,
                                        lahodnou chutí. Znaèka INKOSPOR zaruèuje maximální úroveò bezpeènosti svıch vırobkù.
                                        Kadı se mùe snadno pøesvìdèit, e heslo "prémiová kvalita" pro nás v ádném pøípadì
                                        není jen prázdnım pojmem.
                                        <br />
                                    </div>
                                </li>
                                <li>
                                    <div class="partneri">
                                        ...
                                        Nejzákladnìjší filosofií znaèky MOOSE je nabídnout svım zákazníkùm technicky i materiálovì
                                        propracované vırobky za pøijatelnou cenu. MOOSE pøevádí poznatky z vrcholového sportu
                                        do kadodenního ivota, a proto mezi našimi partnery a zákazníky najdete nejen špièkové
                                ...
                                <li>
                                    <div class="partneri">
                                        ...
                                        Jsme na trhu od roku 1997. Specializujeme se na jízdní kola, lyování a snowboarding.
                                        Provádíme servis jízdních kol a lyí. Na prodejnì v Tøebíèi prodáváme zboí renomovanıch
                                        znaèek jako jsou SPECIALIZED, ELAN, SUPERIOR, SCOTT, FELT, GHOST, CITY BIKES aj.
                                        Nechceme Vám prodat kolo, které doruèí pøepravní sluba a tím to pro nás skonèí.
                                        Snad kadé dobré zboí si zaslouí trochu té prodejní kultury. Trochu si o vybraném
                                        zboí a o daném sportu popovídat, vyzkoušet si zboí, mít z nákupu pøirozenou radost.
                                        Vybrané zboí si mùete otestovat i formou zapùjèení.
                                        <br />
                                    </div>
                                </li>
                                <li>
                                    <div class="partneri">
                                        ...
                                        a lye a celı náš sortiment nadále rozšiøovat. V dnešní dobì ji nabízíme prodej kol znaèek
                                        Pells, Superior, Haibike, Mondraker, CTM, Norco. Ve vybavení pro lyaøe se specializujeme
                                        ...
                                        je dùleité také správné obleèení, abychom se mohli oddávat našim radovánkám za kadého poèasí
                                        a ji nìkolik let spolupracujeme na té nejvyšší úrovni se znaèkou Nordblanc, Protest, Burton.
                                        <br />
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    <div class="partneri">
                                        ...
                                        cestné maratóny na Slovensku a v susednıch štátoch.<br />
                                        <br />
                                        <br />
                                    </div>
                                </li>
