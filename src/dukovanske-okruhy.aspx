...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div id="pageDukovanskeOkruhyContent">
        ...
        <div id="dukovanskeokruhytabs">
            <ul>
                <li id="Li81"><a href="#tab-info">O závodu</a></li>
                <li id="Li82"><a href="#tab-propozice">Propozice</a></li>
                <li id="Li83"><a href="#tab-trat">Tra</a></li>
                <li id="Li84"><a href="#tab-prihlaska">Pøihláška</a></li>
                <li id="Li85"><a href="#tab-startovka">Startovní listina</a></li>
                <li id="Li86"><a href="#tab-vysledky">Vısledky</a></li>
            ...
            <div id="tab-propozice" class="clasictext">
                    <div class="clanek" >
                        <object data="./files/Dukovanske_okruhy_2020.pdf" style="margin-top:15px" width="930" height="2580" type="application/pdf">
                            <br />
                            Váš prohlíeè nepodporuje zobrazení PDF. Soubor lze stáhnout na tomto odkazu <a href="files/Dukovanske_okruhy_2020.pdf" target="_blank">Dukovanske_okruhy_2020.pdf</a>
                            <br />
                        </object>
                    </div>
            </div>
                    ...
                    <div id="silnicniZavod" style="text-align: left">
                        ...
                        <table width="550px">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Label AssociatedControlID="TextBoxSilnicniZavodLicence" runat="server">Èíslo licence (pokud jste dritelem):</asp:Label>
